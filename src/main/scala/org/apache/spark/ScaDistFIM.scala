...
object ScaDistFIM {
  def main(args: Array[String]): Unit = {
    ...
    val value1: RspRDD[Row] = dataRead.rdd.toRSP(spark.rspRead.parquet("data/TH2_260W_260_26W").rdd.getNumPartitions)
...
//    val value1: RspRDD[Row] = dataRead.rdd.toRSP(dataRead.rdd.getNumPartitions)
//    val dataRSP = spark.createDataFrame(value1, spark.rspRead.parquet("data/TH1_260W_10_26W").schema)
